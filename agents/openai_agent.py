        ...
        tool_function_messages.append(
            {
                ...
                "role": "tool",
                "name": function_name,
                "function_call": function_to_call(user_id=user_id, user_partition=user_partition, content=text, tool_args=function_args),
            }
        )
